...
enum SINAIS {
    ...
    PONTO_VIRGULA, VIRGULA, ASPAS, NEGACAO, AND, OR, ENDERECO, PIPE, POTENCIA
};

enum PAL_RESERV {
    MAIN = 1, BLOCK, ENDBLOCK, CONST, CHAR, INT, REAL, BOOL, WITH, DO,
    VARYING, FROM, TO, DOWNTO, WHILE, FOR, IF, ELSEIF, ELSE, ENDIF, GOBACK, GETINT, GETCHAR,
    PUTINT, PUTREAL, PUTCHAR
};
